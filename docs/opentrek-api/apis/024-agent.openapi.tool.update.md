...
- 文档序号：024
- 分类：平台功能类 / 智能体管理 / 工具 / 编辑工具
- 唯一编码：sfm.api.openapi-agent.agent.openapi.tool.update
- 请求方法：POST
- 调用地址：http://10.128.203.200:30226/gatectl/agent/openapi/tool/update
- 文档版本：1787280870182
...
编辑工具。可以通过查看请求示例，点击 curl 命令示例右侧的调试按钮验证业务接口调用效果。
...
```bash
curl -X 'POST' 'http://10.128.203.200:30226/gatectl/agent/openapi/tool/update' \
-H 'Content-Type: application/json' \
-H 'x-sfm-workspacecode: xxx' \
-H 'Authorization: Bearer YOUR_APP_KEY' \
-d '{"uniqueCode": "a9c81580-8e93-42e1-b331-5cc6506c0093","version": "1759118429269","name": "测试工具","desc": "测试工具","serviceConfig": {}}'
```
...
- apiCode：agent.openapi.tool.update
