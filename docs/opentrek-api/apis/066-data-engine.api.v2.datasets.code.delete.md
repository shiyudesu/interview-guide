...
- 文档序号：066
- 分类：平台功能类 / 数据中心 / 数据管理 / 删除数据集
- 唯一编码：sfm.api.dataprocess.data-engine.api.v2.datasets.Code.delete
- 请求方法：DELETE
...
删除数据集。可以通过查看请求示例，点击 curl 命令示例右侧的调试按钮验证业务接口调用效果。
...
```bash
curl -X 'DELETE' http://10.128.203.200:30226/gatectl/data-engine/api/v2/datasets/${code} \
...
- apiCode：data-engine.api.v2.datasets.Code.delete
