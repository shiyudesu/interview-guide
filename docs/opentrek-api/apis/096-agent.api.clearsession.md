...
- 文档序号：096
- 分类：应用集成类 / 智能体 / 终止session
- 唯一编码：sfm.api.agent.agent.api.clearsession
- 请求方法：POST
- 调用地址：http://10.128.203.200:80/sfm-agent-studio/sfm-api-gateway/gateway/agent/api/clearSession
- 文档版本：1787280869682
...
```bash
curl -X 'POST' http://10.128.203.200:80/sfm-agent-studio/sfm-api-gateway/gateway/agent/api/clearSession \
...
- apiCode：agent.api.clearsession
- groupCode：AGENT
- catalogCode：DEFAULT
