...
- 文档序号：116
- 分类：应用集成类 / 高码智能体 / 终止会话
- 唯一编码：sfm.api.highcodeagent.agent.highcode.abortsession
- 请求方法：POST
- 调用地址：http://10.128.203.200:80/sfm-agent-studio/sfm-api-gateway/gateway/agent/highcode/abortSession
- 文档版本：1787280869870
...
```bash
curl -X 'POST' http://10.128.203.200:80/sfm-agent-studio/sfm-api-gateway/gateway/agent/highcode/abort \
...
- apiCode：agent.highcode.abortsession
