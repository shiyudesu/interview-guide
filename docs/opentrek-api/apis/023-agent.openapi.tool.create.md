...
- 文档序号：023
- 分类：平台功能类 / 智能体管理 / 工具 / 创建工具
- 唯一编码：sfm.api.openapi-agent.agent.openapi.tool.create
- 请求方法：POST
- 调用地址：http://10.128.203.200:30226/gatectl/agent/openapi/tool/create
- 文档版本：1787280870176
...
创建工具。可以通过查看请求示例，点击 curl 命令示例右侧的调试按钮验证业务接口调用效果。
...
| 字段 | 类型 | 必填 | 位置 | 描述 | 示例 |
| --- | --- | --- | --- | --- | --- |
| name | String | 是 | Body | 工具名称 | 测试工具 |
| desc | String | 是 | Body | 工具描述 | 测试工具 |
| serviceConfig | Object | 是 | Body | 工具配置 | {} |
| toolType | String | 是 | Body | 工具类型 | api |
...
```bash
curl -X 'POST' 'http://10.128.203.200:30226/gatectl/agent/openapi/tool/create' \
-H 'Content-Type: application/json' \
-H 'x-sfm-workspacecode: xxx' \
-H 'Authorization: Bearer YOUR_APP_KEY' \
-d '{"name": "测试工具","desc": "测试工具","serviceConfig": {},"toolType": "api"}'
```
...
```json
{
  ...
  "data": {
    "id": 143,
    "gmtCreate": "2025-11-11T13:24:14.501+00:00",
    "gmtModified": "2025-11-11T13:24:14.501+00:00",
    "tenant": "fmthktsjdb",
    "code": "3e8f4bea-298d-40c7-9c41-7adfd4e37940",
    "workspaceCode": "fmthktsjdb",
    "name": "jieyan",
    "version": "1762867454501",
    "desc": "jieyan",
    "toolType": "api",
    "toolSubType": null,
    "owner": {
...
- apiCode：agent.openapi.tool.create
