...
- 文档序号：026
- 分类：平台功能类 / 智能体管理 / 工具 / 删除工具
- 唯一编码：sfm.api.openapi-agent.agent.openapi.tool.delete
- 请求方法：POST
- 调用地址：http://10.128.203.200:30226/gatectl/agent/openapi/tool/delete
- 文档版本：1787280870194
...
删除工具。可以通过查看请求示例，点击 curl 命令示例右侧的调试按钮验证业务接口调用效果。
...
```bash
curl -X 'POST' 'http://10.128.203.200:30226/gatectl/agent/openapi/tool/delete' \
...
- apiCode：agent.openapi.tool.delete
