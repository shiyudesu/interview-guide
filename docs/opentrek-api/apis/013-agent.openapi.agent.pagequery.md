...
- 文档序号：013
- 分类：平台功能类 / 智能体管理 / 智能体 / 查询智能体列表
- 唯一编码：sfm.api.openapi-agent.agent.openapi.agent.pagequery
- 请求方法：POST
- 调用地址：http://10.128.203.200:30226/gatectl/agent/openapi/agent/pageQuery
- 文档版本：1787280870096
...
查询智能体列表。可以通过查看请求示例，点击 curl 命令示例右侧的调试按钮验证业务接口调用效果。
...
| agentName | String | 是 | Body | 智能体名称模糊搜索 | 智能体 |
| bizType | String | 否 | Body | 智能体类型 | agentTrekClaw\|custom\|agentAutoX\|agentBot |
...
| data.list.bizType | String | 是 | Body | 业务类型 | custom |
...
```bash
curl -X 'POST' 'http://10.128.203.200:30226/gatectl/agent/openapi/agent/pageQuery' \
-H 'Content-Type: application/json' \
-H 'x-sfm-workspacecode: xxx' \
-H 'Authorization: Bearer YOUR_APP_KEY' \
-d '{"current": 1,"pageSize": 10,"agentName": "智能体"}'
```
...
```json
{
  ...
  "data": {
    ...
    "list": [
      {
        "id": 188,
        "gmtCreate": "2025-10-23T01:46:02.907+00:00",
        "gmtModified": "2025-10-23T01:46:02.907+00:00",
        "tenant": "fmthktsjdb",
        "agentCode": "52a38b92-88da-48cf-8317-2d22d71beb5c",
        "agentName": "chengmutest",
        "agentDesc": "111",
        "icon": "AGENT_ICON_6",
        "label": null,
        "developer": {
...
- apiCode：agent.openapi.agent.pagequery
