...
def test_initial_sql_contains_only_current_schema() -> None:
    ...
    assert any("CREATE TABLE interview_questions" in statement for statement in statements)
    assert any("CREATE TABLE interview_turns" in statement for statement in statements)
    assert any("CREATE TABLE voice_model_config" in statement for statement in statements)
    assert not any("interview_answers" in statement for statement in statements)
    assert not any("voice_interview_evaluations" in statement for statement in statements)
