...
start_python() {
  ...
  (
    ...
    env \
      ...
      MIGRATION_PROVIDER_NONCE_HEX=000102030405060708090a0b,0c0d0e0f1011121314151617,18191a1b1c1d1e1f20212223,2425262728292a2b2c2d2e2f,303132333435363738393a3b \
      APP_STORAGE_ENDPOINT=http://localhost:19000 \
      APP_STORAGE_ACCESS_KEY=comparison-access \
      APP_STORAGE_SECRET_KEY=comparison-secret \
